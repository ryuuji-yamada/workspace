...
let innerFlex = document.createElement("div");//divクラスを作成
innerFlex.classList.add("d-flex","align-items-center","col-md-7","col-10","m-1");//divクラスに要素を追加
...
//div1のコピーを作成(ElementNode.cloneNode(true))
